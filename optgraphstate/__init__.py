...
class GraphState:
    ...
    graph: ig.Graph
    #: Unraveled graph generated by unraveling the original graph (in
    #: `GraphState.graph`). It is `None` before the unraveled graph is created.
    #:
    #: See Sec. 7 of our tutorial for the list of its vertex attributes.
    unraveled_graph: ig.Graph
    #: Fuson network constructed from the unraveled graph (in
    #: `GraphState.unraveled_graph`) or the original graph (in
    #: `GraphState.graph`). It is `None` before the fusion network is created.
    #:
